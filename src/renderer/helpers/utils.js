...
export function getVideoDropdownOptions(count, videoComponents, hideSharingActions) {
  ...
  if (count > 1) {
    ...
    if (numberOfSavedVideos === count) {
      options.push({
        label: i18n.t('Video.Unsave Video', count, { count: count }),
        value: 'unsave'
      })
    } else if (numberOfUnsavedVideos === count) {
      options.push({
        label: i18n.t('Video.Save Video', count, { count: count }),
        value: 'save'
      })
    } else {
      options.push(
        {
          label: i18n.t('Video.Unsave Video', numberOfUnsavedVideos, { count: numberOfUnsavedVideos }),
          value: 'unsave'
        },
        {
          label: i18n.t('Video.Save Video', numberOfSavedVideos, { count: numberOfSavedVideos }),
          value: 'save'
        }
      )
    }
  ...
  if (numberOfWatchedVideos === count) {
    options.push({
      label: i18n.t('Video.Remove From History', count, { count: count }),
      value: 'history-remove'
    })
  } else if (numberOfUnwatchedVideos === count) {
    options.push({
      label: i18n.t('Video.Mark As Watched', count, { count: count }),
      value: 'history-add'
    })
  } else {
    options.push(
      {
        label: i18n.t('Video.Remove From History', numberOfUnwatchedVideos, { count: numberOfUnwatchedVideos }),
        value: 'history-remove'
      },
      {
        label: i18n.t('Video.Mark As Watched', numberOfWatchedVideos, { count: numberOfWatchedVideos }),
        value: 'history-add'
      },
    )
  }
  ...
  if (!hideSharingActions) {
    options.push(
      ...
      {
        label: i18n.t('Video.Copy YouTube Link', count, { count: count }),
        value: 'copyYoutube'
      },
      {
        label: i18n.t('Video.Copy YouTube Embedded Player Link', count, { count: count }),
        value: 'copyYoutubeEmbed'
      },
      {
        label: i18n.t('Video.Copy Invidious Link', count, { count: count }),
        value: 'copyInvidious'
      },
      {
        type: 'divider'
      ...
      {
        label: i18n.t('Video.Open in YouTube', count, { count: count }),
        value: 'openYoutube'
      },
      {
        label: i18n.t('Video.Open YouTube Embedded Player', count, { count: count }),
        value: 'openYoutubeEmbed'
      },
      {
        label: i18n.t('Video.Open in Invidious', count, { count: count }),
        value: 'openInvidious'
      }
    )
    if (videosWithChannelIds) {
      options.push(
        ...
        {
          label: i18n.t('Video.Copy YouTube Channel Link', videosWithChannelIds, { count: videosWithChannelIds }),
          value: 'copyYoutubeChannel'
        },
        {
          label: i18n.t('Video.Copy Invidious Channel Link', videosWithChannelIds, { count: videosWithChannelIds }),
        ...
        {
          label: i18n.t('Video.Open Channel in YouTube', videosWithChannelIds, { count: videosWithChannelIds }),
          value: 'openYoutubeChannel'
        },
        {
          label: i18n.t('Video.Open Channel in Invidious', videosWithChannelIds, { count: videosWithChannelIds }),
...
export function handleVideoDropdownOptionsClick(option, count, videoComponents) {
  switch (option) {
    ...
    case 'save':
      ...
      showToast(i18n.t('Video.Video has been saved', numberOfUnsavedVideos, { count: numberOfUnsavedVideos }))
      break
    case 'unsave':
      videoComponents.forEach((videoComponent) => videoComponent.setSave(false, true))
      showToast(i18n.t('Video.Video has been removed from your history', numberOfSavedVideos, { count: numberOfSavedVideos }))
      break
    case 'history-add':
      videoComponents.forEach((videoComponent) => videoComponent.markAsWatched(true))
      showToast(i18n.t('Video.Video has been marked as watched', numberOfUnwatchedVideos, { count: numberOfUnwatchedVideos }))
      break
    case 'history-remove':
      videoComponents.forEach((videoComponent) => videoComponent.removeFromWatched(true))
      showToast(i18n.t('Video.Video has been removed from your history', numberOfWatchedVideos, { count: numberOfWatchedVideos }))
      break
    case 'copyYoutube':
      copyToClipboard(
        videoComponents.map(videoComponent => videoComponent.youtubeShareUrl).join('\n'),
        { messageOnSuccess: i18n.t('Share.YouTube URL copied to clipboard', count, { count: count }) })
      break
    case 'openYoutube':
    ...
    case 'copyYoutubeEmbed':
      copyToClipboard(
        ...
        { messageOnSuccess: i18n.t('Share.YouTube Embed URL copied to clipboard', count, { count: count }) })
      break
    ...
    case 'copyInvidious':
      copyToClipboard(
        ...
        { messageOnSuccess: i18n.t('Share.Invidious URL copied to clipboard', count, { count: count }) })
      break
    case 'openInvidious':
    ...
    case 'copyYoutubeChannel':
      copyToClipboard(
        ...
        { messageOnSuccess: i18n.t('Share.YouTube Channel URL copied to clipboard', videosWithChannelIds, { count: videosWithChannelIds }) })
      break
    ...
    case 'copyInvidiousChannel':
      copyToClipboard(
        ...
        { messageOnSuccess: i18n.t('Share.Invidious Channel URL copied to clipboard', videosWithChannelIds, { count: videosWithChannelIds }) }
      )
      break
